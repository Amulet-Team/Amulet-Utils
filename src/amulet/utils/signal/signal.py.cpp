...
{
    // This is a bit janky
    // amulet.utils.signal is a pure python package but we need
    ...
    std::string full_name = std::string(m_parent_name) + ".signal._connection_mode";
    ...
    // Initialise amulet.utils.signal._connection_mode
