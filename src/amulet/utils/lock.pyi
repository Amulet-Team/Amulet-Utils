...
class ThreadAccessMode:
    ...
    Read: typing.ClassVar[ThreadAccessMode]
    ReadWrite: typing.ClassVar[ThreadAccessMode]
    __members__: typing.ClassVar[dict[str, ThreadAccessMode]]
...
class ThreadShareMode:
    ...
    SharedReadOnly: typing.ClassVar[ThreadShareMode]
    SharedReadWrite: typing.ClassVar[ThreadShareMode]
    Unique: typing.ClassVar[ThreadShareMode]
    __members__: typing.ClassVar[dict[str, ThreadShareMode]]
    def __eq__(self, other: typing.Any) -> bool: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
    def __init__(self, value: typing.SupportsInt | typing.SupportsIndex) -> None: ...
...
class OrderedLock:
    ...
    def __call__(
        self,
        blocking: bool = True,
        timeout: typing.SupportsFloat | typing.SupportsIndex = -1.0,
